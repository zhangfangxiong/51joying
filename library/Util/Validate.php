...
class Util_Validate
{
    ...
    public static function isELength($data, $min, $max)
    {
        return preg_match("/[0-9a-z]{" . $min . "," . $max . "}/i", $data);
    }
    ...
    public static function isIntLength($data, $min, $max)
    {
        return preg_match("/[0-9]{" . $min . "," . $max . "}/", $data);
    }
