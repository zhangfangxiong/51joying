...
class Admin_Model_Article extends Admin_Model_Base
{
    ...
    {
        return Admin_Model_Type::getOption(self::getClass($sClass, 'sTag'));
    }
    ...
    {
        return Admin_Model_Type::getOption(self::getClass($sClass, 'sAuthor'));
    }
    ...
    {
        return Admin_Model_Type::getOption(self::getClass($sClass, 'sCategory'));
    }
...
//         echo $sSQL;exit;
        $aRet['aList'] = self::query($sSQL, 'all');
    ...
    public static function updateDayStat ($iArticleID, $iType = 1)
    {
        ...
        return Admin_Model_Article::updData($aData);
    }
