 ...
 *
 */
class Admin_Model_Type extends Admin_Model_Base
{
    ...
    public static function getAutocomplete ($sClass, $sKey)
    {
        ...
        foreach($aList as &$v) {
            $v['sUrl'] = 'http://www.163.com';
            $v['sImageShow'] = Util_Uri::getDFSViewURL($v['sImage']);
            unset($v['iParentID'],$v['iOrder'],$v['iStatus'],$v['iCreateTime'],$v['iUpdateTime'],$v['sClass']);
        }
