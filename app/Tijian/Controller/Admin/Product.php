 ...
 * Time: 9:50
 */
class Tijian_Controller_Admin_Product extends Tijian_Controller_Admin_ItemBase
{
    const PAGESIZE = 20;
    ...
    protected function _editHeader($iEditHeaderIndex, $iHeaderType)
    {
        $aEditHeaderInfo = [
            1 => [
                'editurl' => '/tijian/admin/product/editbaseinfo/',
                'viewurl' => '/tijian/admin/product/viewbaseinfo/',
                'name' => '基本信息'
            ],
            2 => [
                'editurl' => '/tijian/admin/product/edititem/',
                'viewurl' => '/tijian/admin/product/viewitem/',
                'name' => '体检单项'
            ],
            3 => [
                'editurl' => '/tijian/admin/product/editstore/',
                'viewurl' => '/tijian/admin/product/viewstore/',
                'name' => '供应商门店'
            ],
            4 => [
                'editurl' => '/tijian/admin/product/editupgrade/',
                'viewurl' => '/tijian/admin/product/viewupgrade/',
                'name' => '升级产品'
            ],
            5 => [
                'editurl' => '/tijian/admin/product/editaddtion/',
                'viewurl' => '/tijian/admin/product/viewaddtion/',
                'name' => '加项包'
            ],
            6 => [
                'editurl' => '/tijian/admin/product/editexpand/',
                'viewurl' => '/tijian/admin/product/sonlist/',
                'name' => '拓展产品'
            ]
        ];
    ...
    protected function _assignUrl()
    {
        ...
        $this->assign('sAddBaseInfoUrl', '/tijian/admin/product/addbaseinfo/');
        $this->assign('sEditBaseInfoUrl', '/tijian/admin/product/editbaseinfo/');
        $this->assign('sViewBaseInfoUrl', '/tijian/admin/product/viewbaseinfo/');
        $this->assign('sEpEditBaseInfoUrl', '/tijian/admin/eproduct/editbaseinfo/');
        $this->assign('sEpViewBaseInfoUrl', '/tijian/admin/eproduct/viewbaseinfo/');
        $this->assign('sAddItemUrl', '/tijian/admin/product/additem/');
        $this->assign('sEditItemUrl', '/tijian/admin/product/edititem/');
        $this->assign('sViewItemUrl', '/tijian/admin/product/viewitem/');
        $this->assign('sInsertItemUrl', '/tijian/admin/product/insertitem/');
        $this->assign('sDeleteItemUrl', '/tijian/admin/product/deleteitem/');
        $this->assign('sAddStoreUrl', '/tijian/admin/product/addstore/');
        $this->assign('sEditStoreUrl', '/tijian/admin/product/editstore/');
        $this->assign('sViewStoreUrl', '/tijian/admin/product/viewstore/');
        $this->assign('sInsertStoreUrl', '/tijian/admin/product/insertstore/');
        $this->assign('sDeleteStoreUrl', '/tijian/admin/product/deletestore/');
        $this->assign('sAddUpgradeUrl', '/tijian/admin/product/addupgrade/');
        $this->assign('sEditUpgradeUrl', '/tijian/admin/product/editupgrade/');
        $this->assign('sViewUpgradeUrl', '/tijian/admin/product/viewupgrade/');
        $this->assign('sInsertUpgradeUrl', '/tijian/admin/product/insertupgrade/');
        $this->assign('sDeleteUpgradeUrl', '/tijian/admin/product/deleteupgrade/');
        $this->assign('sAddAddtionUrl', '/tijian/admin/product/addaddtion/');
        $this->assign('sEditAddtionUrl', '/tijian/admin/product/editaddtion/');
        $this->assign('sViewAddtionUrl', '/tijian/admin/product/viewaddtion/');
        $this->assign('sInsertAddtionUrl', '/tijian/admin/product/insertaddtion/');
        $this->assign('sDeleteAddtionUrl', '/tijian/admin/product/deleteaddtion/');
//todo
        $this->assign('sAddExpandUrl', '/tijian/admin/product/addexpand/');
        $this->assign('sInsertExpandUrl', '/tijian/admin/product/insertexpand/');
        $this->assign('sDeleteExpandUrl', '/tijian/admin/product/deleteexpand/');
    }
    ...
    public function listAction()
    {
        ...
        if ($iSelectStore) {
            $aTmp = Tijian_Model_Store::getData($aParam);//满足条件的门店
            $aStoreIDs = [];
            if (!empty($aTmp)) {
                foreach ($aTmp as $key => $value) {
                    $aStoreIDs[] = $value['iStoreID'];
                }
                $aProduct = Tijian_Model_ProductStore::getDataByStores($aStoreIDs, Tijian_Model_ProductStore::BASEPRODUCT);
                if (!empty($aProduct)) {
        ...
        $aParam['iType'] = Tijian_Model_Product::TYPE_BASE;
        $aData = Tijian_Model_Product::getPageList($aParam, $iPage, 'iUpdateTime DESC', $iPageSize);
        ...
        if (!empty($aData['aList'])) {
            ...
            foreach ($aData['aList'] as $key => $value) {
                ...
                //统计拓展产品数目
                $aSonProduct = Tijian_Model_Product::getExplandData($value['iProductID']);
        ...
        $this->assign('iType', Tijian_Model_Product::TYPE_BASE);
    ...
    public function addBaseInfoAction()
    {
        if ($this->_request->isPost()) {
            ...
            $aProduct['sProductCode'] = Tijian_Model_Product::initProductCode();
            $aProduct['iType'] = Tijian_Model_Product::TYPE_BASE;
            ...
            if ($iLastInsertID = Tijian_Model_Product::addData($aProduct)) {
                $sNextUrl = '/tijian/admin/product/additem/id/' . $iLastInsertID;
    ...
    public function editBaseInfoAction()
    {
        if ($this->_request->isPost()) {
            ...
            if (Tijian_Model_Product::updData($aProduct) > 0) {
    ...
    private function _item()
    {
        ...
        $aHasItem = Tijian_Model_ProductItem::getProductItems($iProductID, Tijian_Model_ProductItem::BASEPRODUCT,1);//该产品已包含的单项
        if (!empty($aHasItem)) {
            //整合需要的数据
            $aHasItemID = [];
        ...
        $sNextUrl = '/tijian/admin/product/addstore/id/' . $iProductID;
    ...
    public function insertItemAction()
    {
        ...
        $aParam['iType'] = Tijian_Model_ProductItem::BASEPRODUCT;//基础产品
        $aParam['iStatus'] = 1;
        if ($iCommitType) {//批量
            ...
            foreach ($aItemID as $key => $value) {
                //判断是否存在该单项
                if (Tijian_Model_ProductItem::getDataByItemID($iProductID, $value, Tijian_Model_ProductItem::BASEPRODUCT)) {
                    continue;
                }
            ...
            //判断是否存在该单项
            if (Tijian_Model_ProductItem::getDataByItemID($iProductID, $aParam['iItemID'], Tijian_Model_ProductItem::BASEPRODUCT)) {
    ...
    private function _store()
    {
        ...
        $aHasStoreParam['iType'] = Tijian_Model_ProductStore::BASEPRODUCT;
    ...
    public function insertStoreAction()
    {
        ...
        $aParam['iProductID'] = $iProductID;
        $aParam['iCreateUserID'] = $aParam['iLastUpdateUserID'] = $this->aCurrUser['iUserID'];
        $aParam['iType'] = Tijian_Model_ProductStore::BASEPRODUCT;//基础产品
        $aParam['iStatus'] = 1;
        if ($iCommitType) {//批量
            ...
            foreach ($aStoreID as $key => $value) {
                //判断是否存在该门店
                if (Tijian_Model_ProductStore::getDataByStoreID($iProductID, $value, Tijian_Model_ProductStore::BASEPRODUCT)) {
                    continue;
                }
            ...
            //判断是否存在该门店
            if (Tijian_Model_ProductStore::getDataByStoreID($iProductID, $aParam['iStoreID'], Tijian_Model_ProductStore::BASEPRODUCT)) {
    ...
    private function _upgrade()
    {
        ...
        $aHasUpgrade = Tijian_Model_ProductUpgrade::getProductUpgrades($iProductID, Tijian_Model_ProductUpgrade::BASEPRODUCT);//该产品已包含的升级产品
        $aParam['iType'] = Tijian_Model_Product::TYPE_BASE;
        $aParam['iStatus'] = 1;
        ...
        if (!empty($aUpgrade['aList'])) {
            foreach ($aUpgrade['aList'] as $key => $value) {
                $aStore = Tijian_Model_ProductStore::getProductStores($value['iProductID'], Tijian_Model_ProductStore::BASEPRODUCT);
    ...
    public function insertUpgradeAction()
    {
        ...
        $aParam['iProductID'] = $iProductID;
        $aParam['iCreateUserID'] = $aParam['iLastUpdateUserID'] = $this->aCurrUser['iUserID'];
        $aParam['iType'] = Tijian_Model_ProductUpgrade::BASEPRODUCT;//基础产品
        $aParam['iStatus'] = 1;
        if ($iCommitType) {//批量
            ...
            foreach ($aUpgradeID as $key => $value) {
                //判断是否存在该升级产品
                if (Tijian_Model_ProductUpgrade::getDataByUpgradeID($iProductID, $value, Tijian_Model_ProductUpgrade::BASEPRODUCT)) {
                    continue;
                }
                $aParam['iUpgradeID'] = $value;
                if (Tijian_Model_ProductUpgrade::addData($aParam)) {
                    $sSuccessNum++;
                }
            }
            ...
            //判断是否存在该升级产品
            if (Tijian_Model_ProductUpgrade::getDataByUpgradeID($iProductID, $aParam['iUpgradeID'], Tijian_Model_ProductUpgrade::BASEPRODUCT)) {
    ...
    public function deleteUpgradeAction()
    {
        ...
        if ($iCommitType) {//批量
            ...
            foreach ($aUpgradeID as $key => $value) {
                //判断是否存在该升级产品
                if (!Tijian_Model_ProductUpgrade::getDetail($value)) {
                    continue;
                }
                $aParam['iAutoID'] = $value;
                if (Tijian_Model_ProductUpgrade::updData($aParam)) {
                    $sSuccessNum++;
                }
            }
    ...
    private function _addtion()
    {
        ...
        $aHasAddtion = Tijian_Model_ProductAddtion::getProductAddtions($iProductID, Tijian_Model_ProductAddtion::BASEPRODUCT);//该产品已包含的加项包
    ...
    public function sonListAction()
    {
        ...
        if (!empty($aStoreParam)) {
            ...
            if (!empty($aTmp)) {
                ...
                $aProductStore = Tijian_Model_ProductStore::getDataByStores($aStoreIDs, Tijian_Model_ProductStore::EXPANDPRODUCT);
        ...
        if (!empty($aChannelParam)) {
            $aProductChannel = Tijian_Model_ProductChannel::getProductByChannel($aParam['aChannel']);
            $aTmp = [];
            if (!empty($aProductChannel)) {
                foreach ($aProductChannel as $key => $value) {
                    ...
                    if(Tijian_Model_Product::getRow($aChannelParam))
                    {
        ...
        if (!empty($aData['aList'])) {
            ...
            //基础产品单项数目
            $aProductItem = Tijian_Model_ProductItem::getProductItems($iProductID, Tijian_Model_ProductItem::BASEPRODUCT,1,true);
            foreach ($aData['aList'] as $key => $value) {
    ...
    public function insertAddtionAction()
    {
        ...
        $aParam['iProductID'] = $iProductID;
        $aParam['iCreateUserID'] = $aParam['iLastUpdateUserID'] = $this->aCurrUser['iUserID'];
        $aParam['iType'] = Tijian_Model_ProductAddtion::BASEPRODUCT;//基础产品
        $aParam['iStatus'] = 1;
        if ($iCommitType) {//批量
            ...
            foreach ($aAddtionID as $key => $value) {
                //判断是否存在该加项包
                if (Tijian_Model_ProductAddtion::getDataByAddtionID($iProductID, $value, Tijian_Model_ProductAddtion::BASEPRODUCT)) {
                    continue;
                }
                $aParam['iAddtionID'] = $value;
                if (Tijian_Model_ProductAddtion::addData($aParam)) {
                    $sSuccessNum++;
                }
            }
            ...
            //判断是否存在该加项包
            if (Tijian_Model_ProductAddtion::getDataByAddtionID($iProductID, $aParam['iAddtionID'], Tijian_Model_ProductAddtion::BASEPRODUCT)) {
    ...
    public function deleteAddtionAction()
    {
        ...
        if ($iCommitType) {//批量
            ...
            foreach ($aAddtionID as $key => $value) {
                //判断是否存在该加项包
                if (!Tijian_Model_ProductAddtion::getDetail($value)) {
                    continue;
                }
                $aParam['iAutoID'] = $value;
                if (Tijian_Model_ProductAddtion::updData($aParam)) {
                    $sSuccessNum++;
                }
            }
    ...
    public function importItemAction ()
    {
        ...
        if ($ret) {
            ...
            for ($i = 2; $i <= $allRow; $i++) { //第1行是表头,从第2行开始读取
                ...
                $row = Tijian_Model_ProductItem::getRow(['where' => $where]);
                if ($row) {
                    continue;
                }
                ...
                Tijian_Model_ProductItem::addData($where);
            }           
