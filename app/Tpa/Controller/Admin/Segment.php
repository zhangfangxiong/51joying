...
class Tpa_Controller_Admin_Segment extends Tpa_Controller_Admin_Base
{
	...
	public function actionBefore ()
	{
		...
		$this->aStaff = Tpa_Model_User::getPair();
	...
	public function listAction ()
	{
		...
		$aList = Tpa_Model_Segment::getList($where, $page);
	...
	public function checkAddParam ()
	{
		...
		list($data['iStart'], $data['iEnd']) = Tpa_Model_Segment::getSegmentRange($data['sDealDate']);
	...
	public function addSegmentAction ()
	{
		...
		if ($this->isPost()) {
			...
			$data['iStatus'] = Tpa_Model_Segment::STATUS_ASSIGNED;
			Tpa_Model_Segment::addData($where);
