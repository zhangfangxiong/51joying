...
class Tpa_Controller_Admin_Dept extends Tpa_Controller_Admin_Base
{
    ...
    public function actionBefore() {
        ...
        if ($this->departmentId) {
            $this->aDept = Tpa_Model_Dept::getDetail($this->departmentId);
        }
        
        $aTree = Tpa_Model_Dept::getTree();
    ...
    public function indexAction ()
    {
        ...
        $sDeptIDs = Tpa_Model_Dept::getSubDeptIDs($this->departmentId);
        $sDeptIDs ? $sDeptIDs .= ',' . $this->departmentId : $sDeptIDs = $this->departmentId;
        
        $aWhere = ['iDeptID IN' => $sDeptIDs];
        $aAdmin = Tpa_Model_User::getList($aWhere, $page);
    ...
    public function addAction ()
    {
        if ($this->isPost()) {
            ...
            $addID = Tpa_Model_Dept::addData($aDept);
            ...
            $aDept['sNumber'] = Tpa_Model_Dept::initDeptCode();
    ...
    public function editAction ()
    {
        if ($this->isPost()) {	
            ...
            $update = Tpa_Model_Dept::updData($aDept);
