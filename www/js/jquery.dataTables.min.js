...
sSortableDesc:"ui-state-default",sSortableNone:"ui-state-default",sSortJUIAsc:"css_right ui-icon ui-fa-triangle-1-n",sSortJUIDesc:"css_right ui-icon ui-fa-triangle-1-s",sSortJUI:"css_right ui-icon ui-fa-carat-2-n-s",sSortJUIAscAllowed:"css_right ui-icon ui-fa-carat-1-n",sSortJUIDescAllowed:"css_right ui-icon ui-fa-carat-1-s",sSortJUIWrapper:"DataTables_sort_wrapper",sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead ui-state-default",sScrollFoot:"dataTables_scrollFoot ui-state-default",
